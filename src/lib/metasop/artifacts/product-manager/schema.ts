...
export const pmSchema = {
    ...
    properties: {
        ...
        swot: {
            ...
            properties: {
                strengths: { type: "array", items: { type: "string", maxLength: 50 }, description: "Internal positive attributes of the product." },
                weaknesses: { type: "array", items: { type: "string", maxLength: 50 }, description: "Internal negative attributes or limitations." },
                opportunities: { type: "array", items: { type: "string", maxLength: 50 }, description: "External factors that could lead to product success." },
                threats: { type: "array", items: { type: "string", maxLength: 50 }, description: "External factors that could jeopardize the product." },
            },
        ...
        invest_analysis: {
            ...
            items: {
                ...
                properties: {
                    ...
                    independent: { type: "boolean", description: "Does the story have dependencies on other stories? (INVEST: Independent)" },
                    negotiable: { type: "boolean", description: "Is the story flexible and open to discussion? (INVEST: Negotiable)" },
                    valuable: { type: "boolean", description: "Does the story provide clear value to users? (INVEST: Valuable)" },
                    estimatable: { type: "boolean", description: "Can the complexity of the story be estimated? (INVEST: Estimatable)" },
                    small: { type: "boolean", description: "Is the story sized appropriately for a single sprint? (INVEST: Small)" },
                    testable: { type: "boolean", description: "Can the story be verified with clear criteria? (INVEST: Testable)" },
                    score: { type: "number", minimum: 0, maximum: 10, description: "Calculated INVEST fitness score (0-10)." },
                    comments: { type: "string", maxLength: 100, description: "PM notes on the INVEST analysis for this story." },
                },
            },
